...
function Detail() {
    ...
    const { isFetching,error,isError,status, data } = useQuery({
    ...
    return isError ? (
        <div className="text-center my-20 dark:text-slate-50">{error.message}<br/><br/><Link className="btn-blue" to="/">Go back to mainpage</Link></div>
    ) : status === "loading" ? (
        ...
        <div className="overflow-hidden py-2">
                ...
                <div className="flex flex-col md:flex-row w-full">
                    ...
                    <div className="w-full md:w-1/2 px-4">
                        ...
                        <table className="my-12 dark:text-slate-200 w-full rounded-lg bg-slate-50/[.3] dark:bg-slate-900/[.3] border-separate border-spacing-1">
                            <thead>
                            <tr>
