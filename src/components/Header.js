    ...
    return (
        <div className="border-b border-white/[.4] grid grid-cols-1 md:grid-cols-6">
            ...
            <div className="h-14 col-span-3 flex flex-col justify-center">
                <form className="" onSubmit={doSearch}>
                    <div className="relative w-11/12 md:w-9/12 lg:w-3/5" style={{margin:"0 auto"}}>
                        ...
                        <input type="text" id="text" placeholder="Enter text ..." className="w-full rounded-lg focus:outline-none pl-10 pr-20 py-2 bg-black/[.06] dark:bg-black/[.2] text-white/[.9] border border-white/[.7] focus:border-white/[.9] placeholder:text-white/[.7]" required />
